...
- **`bb-methodology`** — When Phase 5's report-writing step starts. Workflow primitive: Phase 5 calls `$codex-bughunter:workflow-report` which loads this skill for the platform-specific template (H1 / Bugcrowd / Intigriti / Immunefi).
