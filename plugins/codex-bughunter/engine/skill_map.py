...
skills/ for repo/plugin installs, or ~/.agents/skills for the copy installer, overridable
...
def _resolve_skills_dir():
    ...
    Resolution order:
      ...
      2. skills/ shipped next to the engine — works for both a repo checkout and a
         Codex plugin install (the whole bundle lives in the plugin cache, so
         engine/ and skills/ stay siblings there too).
      3. ~/.agents/skills — the target of a legacy copy install.
    """
