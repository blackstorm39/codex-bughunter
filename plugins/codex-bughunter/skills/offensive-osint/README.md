...
Install the `codex-bughunter` plugin, then invoke
`$codex-bughunter:offensive-osint` in Codex. The helper script is packaged with
the skill and needs no separate copy step.
