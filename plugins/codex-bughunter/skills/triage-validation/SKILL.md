...
- **`bb-methodology`** — When Phase 5 (Validate & Report) starts. Workflow primitive: Phase 5's pre-report gate explicitly invokes `$codex-bughunter:workflow-validate` (this skill's 7Q gate) before any report is drafted.
