...
# under ~/Targets/ with AGENTS.md, scope.md, submissions tracker,
...
#   echo 'source ~/.codex/scripts/hunt.sh' >> ~/.zshrc
#   source ~/.zshrc
# =====================================================================
...
PYIN
  ...
  # ============== confirmation ==============
  echo "Initialized $dir with AGENTS.md and engagement template."
  echo "cd $dir to start hacking."
  echo ""
  echo "Files created:"
  echo "  AGENTS.md           - Codex engagement context"
