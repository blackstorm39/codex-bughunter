...
description: "Explicit Codex workflow. Validate a finding — runs 7-Question Gate + 4-gate checklist. Kills weak findings before report writing. Prevents N/A submissions that hurt validity ratio. Invoke only as $codex-bughunter:workflow-validate."
user-invocable: true
...
```
$codex-bughunter:workflow-validate
```
...
**PASS:** "All 7 questions pass. All 4 gates pass. Proceed to $codex-bughunter:workflow-report."
