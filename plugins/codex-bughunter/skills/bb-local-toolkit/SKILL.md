...
description: "Local-tooling companion for authorized bug-bounty work. Use when a hunt needs the installed path or invocation for recon tools, scanners, wordlists, or local clones such as SecLists, trufflehog, ffuf, dalfox, and ghauri. For methodology and routing without local tool discovery, use the bug-bounty skill."
